...
@export_range(0.0, 0.35, 0.01) var halftone_strength: float = 0.11
@export_range(2.0, 10.0, 0.5) var halftone_scale: float = 4.0
...
func _apply_parameters() -> void:
	...
	material.set_shader_parameter("halftone_strength", halftone_strength)
	material.set_shader_parameter("halftone_scale", halftone_scale)
